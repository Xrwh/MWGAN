...
if __name__ == '__main__':
    ...
    # setup
    raw_dir = '/home/yang/project/EGWVSR/codes/data/{}/{}'.format(args.dataset, args.data_type)
    lmdb_dir = '/home/yang/project/EGWVSR/codes/data/{}/{}.lmdb'.format(args.dataset, args.data_type)
    filter_file = ''
